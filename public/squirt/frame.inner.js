...
module.exports = c;
},{"./dom":3,"./evt":4,"./js":7,"./sq":14,"q":20,"underscore":21}],2:[function(require,module,exports){
var evt = require('./evt');
...
},{"./evt":4}],3:[function(require,module,exports){
var js = require('./js'),
...
evt.on(window, 'load', _.partial(slideModalTo, 'settingsClosed', true));
...
},{"./dom":3,"./evt":4,"./keyboard":9,"./settings":13,"./toolbar":15,"underscore":21}],7:[function(require,module,exports){
...
},{"./evt":4,"./sq":14}],10:[function(require,module,exports){
var dom = require('./dom'),
    evt = require('./evt'),
    sq = require('./sq');
...
},{"./dom":3,"./evt":4,"./sq":14}],11:[function(require,module,exports){
var _ = require('underscore'),
    evt = require('./evt'),
    js = require('./js'),
    dom = require('./dom'),
...
},{"./carousel":1,"./dom":3,"./evt":4,"./gui":6,"./js":7,"./word":17,"q":20,"underscore":21}],12:[function(require,module,exports){
var dom = require('./dom'),
    evt = require('./evt'),
    sq = require('./sq');
...
},{"./dom":3,"./evt":4,"./sq":14}],13:[function(require,module,exports){
var _ = require('underscore'),
    dom = require('./dom'),
    evt = require('./evt'),
    js = require('./js'),
...
evt.on(opts, 'click', function(e){
  opts.map(function(opt){ opt.classList.remove('active')});
  e.target.classList.add('active');
  evt.dispatch('squirt.changeFont',
    {sans: e.target.classList.contains("sans")},
    null);
});
...
module.exports = sq;
},{"./dom":3,"underscore":21}],15:[function(require,module,exports){
...
var w = {
  ...
  toNode: function(word) {
    ...
    node.word = word;//w.parseSQInstructionsForWord(word, node);
...
},{"./dom":3,"./evt":4,"./sq":14}],19:[function(require,module,exports){
...
}).call(this,require("/root/squirt.io/client/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"))
},{"/root/squirt.io/client/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":19}],21:[function(require,module,exports){
//     Underscore.js 1.6.0
